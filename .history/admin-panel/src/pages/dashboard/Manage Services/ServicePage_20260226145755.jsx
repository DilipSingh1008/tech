...
const ManageServicesPage = () => {
  ...
  <div className="flex justify-end gap-4">
    ...
    <div className="relative group">
      ...
      <span className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition bg-black text-white text-[10px] px-2 py-1 rounded whitespace-nowrap pointer-events-none z-50">
        Edit service
