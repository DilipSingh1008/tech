...
const SiteSetting = () => {
  ...
  return (
    <div className="p-6 min-h-screen bg-white dark:bg-[#0f172a] transition-colors duration-300">
      {/* Tab Navigation */}
      <div className="flex flex-wrap gap-2 border-b border-gray-200 dark:border-gray-700 mb-6">
        {tabs.map((tab) => (
          <button
            ...
            className={`capitalize px-6 py-2.5 text-sm font-medium transition-all duration-200 border-b-2 ${
              activeTab === tab
      ...
      <div className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#1e293b] text-gray-900 dark:text-gray-100 shadow-sm">
        ...
        <div className="mt-2">
          {activeTab === "site" && <p>Configure your global website identity and SEO here.</p>}
