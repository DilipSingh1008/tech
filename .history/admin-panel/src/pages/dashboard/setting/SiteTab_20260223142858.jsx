    ...
    const fetchData = async () => {
      try {
        ...
        setInitialValues({
          ...
          logo: null, // Files are usually handled separately from the URL strings
          favicon: null,
        });

        // Update previews with the backend URL
        setPreviews({
          ...
          <Form className="space-y-6">
            ...
            <div className="pt-6 border-t border-gray-200 dark:border-gray-800 flex gap-4">
              <button
                ...
                className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all disabled:opacity-50"
              >
