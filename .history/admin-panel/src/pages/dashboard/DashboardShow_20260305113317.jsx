...
const DashboardShow = () => {
  const { data: roleRes, isLoading: rolesLoading } = useGetItemsQuery("user");
  const { data: serviceRes, isLoading: servicesLoading } = useGetItemsQuery("services");
  const { data: productRes, isLoading: productsLoading } = useGetItemsQuery("product-item");
  ...
  // RTK Query provides a refetch function — use that instead of a manual fetch
  const { refetch: refetchRoles } = useGetItemsQuery("user");
  const { refetch: refetchServices } = useGetItemsQuery("services");
  const { refetch: refetchProducts } = useGetItemsQuery("product-item");
