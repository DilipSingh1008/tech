...
const ProfilePage = () => {
  ...
  // --- 1. Formik for Basic Information ---
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <main className="flex-1 overflow-y-auto bg-[#fafafa] dark:bg-[var(--main-bg)]">
          <div className="mx-auto p-1 md:p-10 space-y-10">
            ...
            <div className="bg-white dark:bg-[var(--card-bg)] rounded-xl shadow-sm overflow-hidden border border-gray-100 dark:border-white/5">
                ...
                <div className="flex flex-col md:flex-row gap-10">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    <div className="relative group">
                      <div className="w-24 h-24 rounded-full border-2 border-gray-100 p-1 dark:border-white/10">
                        <div className="w-full h-full rounded-full bg-gray-100 dark:bg-white/5 overflow-hidden flex items-center justify-center text-gray-400">
                          {profilePhotoPreview ? (
                            <img
                      ...
                      <label className="absolute bottom-0 right-0 p-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full shadow-sm cursor-pointer hover:scale-110 transition-transform">
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 text-sm rounded-lg border bg-white dark:bg-transparent outline-none transition-all ${
                          profileForm.touched.fullName && profileForm.errors.fullName
                            ? "border-red-500"
                            : "border-gray-200 dark:border-white/10 focus:border-[var(--primary)]"
                        }`}
                      />
                      {profileForm.touched.fullName && profileForm.errors.fullName && (
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        value="Admin"
                        readOnly
                        className="w-full px-3 py-2 text-sm rounded-lg border bg-gray-50 dark:bg-white/5 border-gray-100 dark:border-white/5 cursor-not-allowed text-gray-400 outline-none"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 text-sm rounded-lg border bg-white dark:bg-transparent border-gray-200 dark:border-white/10 focus:border-[var(--primary)] outline-none`}
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white dark:bg-[var(--card-bg)] rounded-xl border border-gray-100 dark:border-white/5 shadow-sm">
              <form onSubmit={passwordForm.handleSubmit} className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 text-sm rounded-lg border bg-transparent outline-none transition-all ${
                ...
                <div className="pt-4 border-t border-gray-50 dark:border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <button
                    type="submit"
                    disabled={passwordForm.isSubmitting}
                    className="text-sm font-medium text-[var(--primary)] hover:underline flex items-center gap-1 disabled:opacity-50"
                  >
                    {passwordForm.isSubmitting ? "Updating..." : "Update Security Settings"} 
