        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center cursor-pointer gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-semibold transition-colors shadow-sm"
            >
                  ...
                  {isLoading ? (
                    ...
                    countriesData.map((country, index) => (
                      <tr key={country._id} className="hover:bg-blue-500/5 transition-colors">
                        ...
                        <td
                          className="px-4 py-2.5 font-semibold text-sm cursor-pointer hover:text-blue-600"
                        ...
                        <td className="px-4 py-2.5 text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            <button
                              ...
                              className="p-1.5 bg-blue-600/10 text-blue-600 hover:bg-blue-600 hover:text-white rounded-md transition-all"
                              title="Edit"
                            >
                              <FiEdit2 size={14} />
                            </button>
                            <button
                              ...
                              className="p-1.5 bg-red-600/10 text-red-600 hover:bg-red-600 hover:text-white rounded-md transition-all disabled:opacity-30"
            ...
            <div className={`flex items-center justify-between p-3 border-t ${theme.divider}`}>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-1.5 border rounded-md disabled:opacity-30 hover:border-blue-600 hover:text-blue-600 transition-colors"
                >
                  ...
                  <button
                    ...
                    className={`w-7 h-7 text-[11px] rounded-md border transition-all ${
                      page === i + 1
                        ...
                        : "hover:border-blue-600 hover:text-blue-600 border-transparent"
                    }`}
                  >
                    {i + 1}
                  </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-[2px] p-4">
          <div className={`${theme.modal} p-5 rounded-xl w-full max-w-xs shadow-xl border border-gray-700/30`}>
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={closeModal} className="opacity-50 hover:text-blue-600 transition-colors">
                <FiXCircle size={16} />
              </button>
            </div>
            <Formik
                ...
                <Form className="space-y-3">
                  <div>
                    ...
                    <Field
                      ...
                      className={`w-full p-2 text-sm rounded-lg border outline-none focus:border-blue-600 transition-all ${theme.input} ${errors.countryName && touched.countryName ? "border-red-500" : ""}`}
                    />
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold transition-all shadow-md disabled:opacity-50"
                  >
                    {editingCountry
