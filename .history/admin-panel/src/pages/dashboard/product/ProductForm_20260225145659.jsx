...
const ProductForm = () => {
  ...
  // ── Exact same pattern as AddEditServicePage ───────────────────────────────
  useEffect(() => {
    ...
    const loadProduct = async () => {
      if (isEdit) {
        try {
          ...
          // Quill mein description set karo — same as AddEditServicePage
          if (quill) quill.root.innerHTML = prod.mainDescription || "";

          // Subcategories load karo
  ...
  // ── Category change — same as AddEditServicePage ───────────────────────────
