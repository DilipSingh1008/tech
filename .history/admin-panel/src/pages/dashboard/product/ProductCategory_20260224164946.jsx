          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            ...
            >
              <div className="p-6 border-b border-gray-800 flex justify-between items-center">
                ...
                <button onClick={() => setIsModalOpen(false)} className="cursor-pointer hover:opacity-70 transition-opacity">
                  <X size={20} />
                </button>
              </div>
              ...
              <form onSubmit={handleSave} className="p-6 space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-(--primary) text-white rounded-lg text-sm font-bold hover:brightness-110 cursor-pointer"
                >
