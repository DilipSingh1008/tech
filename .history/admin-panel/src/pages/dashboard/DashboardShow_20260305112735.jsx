...
import { getItems, useGetItemsQuery } from "../../services/api";
import {
  Users,
  Briefcase,
  Package,
...
const DashboardShow = () => {
  const {data: roleRes} = useGetItemsQuery("user")
  const {data: serviceRes} = useGetItemsQuery("services")
  const {data: productRes} = useGetItemsQuery("product-item")
