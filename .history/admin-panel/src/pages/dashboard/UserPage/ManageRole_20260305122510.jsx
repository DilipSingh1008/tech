                    ...
                    roles.map((role, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-2.5 font-semibold text-sm capitalize">
                         ...
                         <td className="px-4 py-2.5 hover:text-blue-400 font-semibold cursor-pointer text-sm capitalize" onClick={() => navigate(`/dashboard/manage-permission/${role._id}`)}>
                          Manage
                        </td>
