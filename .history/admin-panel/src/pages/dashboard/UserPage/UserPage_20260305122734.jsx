...
const UserPage = () => {
  ...
  const roleTypeff = useSelector((state) => console.log(state));
                ...
                >
                  {({ setFieldValue, setFieldError, values }) => (
                    <Form className="space-y-3">
                      ...
                      <button
                        type="submit"
                        className="w-full cursor-pointer py-2 mt-2 bg-(--primary) text-white rounded-lg text-xs font-bold hover:bg-(--primary) transition-all"
                      >
