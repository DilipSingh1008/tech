                  ...
                  <div>
                    ...
                    <div className="relative">
                        ...
                        {({ field }) => (
                          <input
                            ...
                            onChange={async (e) => {
                              ...
                              if (value.length >= 3) {
                                const res = await getItems(
                                  `enquiry/search-mobile-number?mobile=${value}`,
                                );
                      ...
                      {showDropdown && mobileResults.length > 0 && (
                        <div className="absolute w-full bg-white border rounded-md mt-1 max-h-40 overflow-y-auto z-50">
                          {mobileResults.map((client) => (
                            <div
                              key={client._id}
                              className="p-2 hover:bg-gray-100 border border-b-2 text-black cursor-pointer text-sm"
                              onClick={() => {
                                // autofill form
