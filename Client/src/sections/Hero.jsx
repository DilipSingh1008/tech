  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(#00e5fa 0.5px, transparent 0.5px)",
      ...
      <div className="relative z-20 max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <button className="w-full sm:w-auto bg-[#00e5fa] hover:bg-white text-black px-10 py-4 rounded-xl font-black transition-all duration-300 transform hover:-translate-y-1 shadow-[0_0_20px_rgba(0,229,250,0.3)]">
            Start Your Project
          </button>
