          ...
          <form onSubmit={formik.handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail
                  className={`absolute left-3 top-1/2 -translate-y-1/2 ${formik.touched.email && formik.errors.email ? "text-red-400" : "text-[var(--text-muted)]"}`}
                  size={18}
                />
                <input
                  name="email"
              ...
              {formik.touched.email && formik.errors.email && (
                <p className="text-[10px] text-red-400 ml-1 mt-1 uppercase font-bold tracking-tight">
                  {formik.errors.email}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Edit3
                  className={`absolute left-3 top-1/2 -translate-y-1/2 ${formik.touched.password && formik.errors.password ? "text-red-400" : "text-[var(--text-muted)]"}`}
                  size={18}
                />
                <input
                  name="password"
